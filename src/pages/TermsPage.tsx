  ...
  <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
    ...
    <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col">
      <div className="sticky top-0 bg-white border-b border-stone-100 px-6 py-4 flex items-center justify-between rounded-t-xl">
        <div>
          <h3 className="text-lg font-bold text-stone-900">이용약관</h3>
          <p className="text-xs text-stone-500 mt-0.5">EYEVACS 서비스 이용약관</p>
        </div>
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제1조 (목적)</h3>
        <p>본 약관은 주식회사 EYEVACS(이하 "회사")가 제공하는 우리동네 사장님 센터 서비스(이하 "서비스")의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
      </section>

      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제2조 (정의)</h3>
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제3조 (약관의 효력 및 변경)</h3>
        <ol className="list-decimal ml-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제4조 (서비스 이용계약의 성립)</h3>
        <ol className="list-decimal ml-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제5조 (서비스 내용)</h3>
        <ol className="list-decimal ml-5 space-y-1">
          <li>가게 정보 등록 및 관리</li>
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제6조 (유료 서비스)</h3>
        <ol className="list-decimal ml-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제7조 (이용자의 의무)</h3>
        <ol className="list-decimal ml-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제8조 (서비스 중단)</h3>
        <p>회사는 시스템 점검, 장비 교체, 천재지변 등 불가피한 경우 서비스를 일시 중단할 수 있으며, 사전에 공지합니다.</p>
      </section>

      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제9조 (계약 해지 및 회원 탈퇴)</h3>
        <ol className="list-decimal ml-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제10조 (면책)</h3>
        <ol className="list-decimal ml-5 space-y-1">
      ...
      <section>
        <h3 className="text-base font-bold text-stone-900 mb-2">제11조 (분쟁 해결)</h3>
